...
- **n8n**: The core low-code automation engine used to build AI agents and process workflows. **All used n8n workflows are located in the folder n8n/demo-data/workflows.**.
